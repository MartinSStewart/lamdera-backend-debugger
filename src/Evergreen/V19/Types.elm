...
type alias BackendMsgEvent_ =
    { msg : Evergreen.V19.DebugParser.ElmValue.ElmValue
    , newModel : Evergreen.V19.DebugParser.ElmValue.ElmValue
    }
...
type PathNode
    ...
    | VariantNode String
    | SequenceNode Int
    | DictNode Evergreen.V19.DebugParser.ElmValue.ElmValue


type alias LoadedData =
    { key : Browser.Navigation.Key
    , sessionName : SessionName
    , initialModel : Maybe Evergreen.V19.DebugParser.ElmValue.ElmValue
...
type alias Init_ =
    { sessionName : SessionName
    , model : Evergreen.V19.DebugParser.ElmValue.ElmValue
    }
