...
type alias BackendMsgEvent_ =
    { msg : Evergreen.V31.DebugParser.ElmValue.ElmValue
    , newModel : Evergreen.V31.DebugParser.ElmValue.ElmValue
    , cmd : Maybe Evergreen.V31.DebugParser.ElmValue.ElmValue
    }
...
type PathNode
    ...
    | VariantNode String
    | SequenceNode Int
    | DictNode Evergreen.V31.DebugParser.ElmValue.ElmValue
...
type alias LoadedData =
    { key : Browser.Navigation.Key
    , sessionName : SessionName
    , initialModel : Maybe Evergreen.V31.DebugParser.ElmValue.ElmValue
    , initialCmd : Maybe Evergreen.V31.DebugParser.ElmValue.ElmValue
...
type alias Init_ =
    { sessionName : SessionName
    , model : Evergreen.V31.DebugParser.ElmValue.ElmValue
    , maybeCmd : Maybe Evergreen.V31.DebugParser.ElmValue.ElmValue
    }
