...
type alias BackendMsgEvent_ =
    { msg : Evergreen.V12.DebugParser.ElmValue.ElmValue
    , newModel : Evergreen.V12.DebugParser.ElmValue.ElmValue
    }
...
type alias LoadedData =
    { key : Browser.Navigation.Key
    , sessionName : SessionName
    , initialModel : Maybe Evergreen.V12.DebugParser.ElmValue.ElmValue
...
type alias Init_ =
    { sessionName : SessionName
    , model : Evergreen.V12.DebugParser.ElmValue.ElmValue
    }
