...
type alias BackendMsgEvent_ =
    { msg : Evergreen.V21.DebugParser.ElmValue.ElmValue
    , newModel : Evergreen.V21.DebugParser.ElmValue.ElmValue
    , cmd : Maybe Evergreen.V21.DebugParser.ElmValue.ElmValue
    }
...
type PathNode
    ...
    | VariantNode String
    | SequenceNode Int
    | DictNode Evergreen.V21.DebugParser.ElmValue.ElmValue
...
type alias LoadedData =
    { key : Browser.Navigation.Key
    , sessionName : SessionName
    , initialModel : Maybe Evergreen.V21.DebugParser.ElmValue.ElmValue
    , initialCmd : Maybe Evergreen.V21.DebugParser.ElmValue.ElmValue
...
type alias Init_ =
    { sessionName : SessionName
    , model : Evergreen.V21.DebugParser.ElmValue.ElmValue
    , maybeCmd : Maybe Evergreen.V21.DebugParser.ElmValue.ElmValue
    }
